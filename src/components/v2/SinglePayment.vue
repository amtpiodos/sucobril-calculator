    ...
    <div class="flex m-">
        <div class="w-1/5">
            <div class="flex">
                ...
                <div class="w-3/4"> <p class="text-center border border-gray-500 bg-gray-100 text-sm font-regular"> {{ buyer_payment.date.toDateString() }} </p> </div> -->
                <div class="w-full"> <p class="text-center border border-gray-500 bg-gray-100 text-sm font-regular"> {{ buyer_payment.date.toDateString() }} </p> </div>
            </div>
        </div>
        <div class="w-1/5">
