        ...
        <div class="my-5 mx-24 px-5">
            <div v-if="!isFetchingData">
                ...
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 py-1"
                    v-if="payment.reservation_type == 1 || payment.reservation_type == 2
                    || payment.reservation_type == 3 || payment.reservation_type == 4">
                    ...
                    <div class="full"> <readonly-form label="Required Equity" :value="0" /> </div>
                    <div class="flex gap-4">
                    ...
                    <div class="full"> <readonly-form label="Equity Net of Reservation:" :value="0" /> </div>
                    <div class="flex gap-4">
                    ...
                    <div class="full"> <readonly-form label="Required Loanable Amount" :value="0" /> </div>
                    <div class="full"> <readonly-form label="Project Address" :value="buyer.project.location" /> </div>
                    <div class="full"> <readonly-form label="Running Equity Balance" :value="0" /> </div>
                    <div class="full"> <readonly-form label="Reservation Fee" :value="payment.reservation_fee" /> </div>
                    ...
                    <!-- <div class="full"> <readonly-form label="Total Payments Made" :value="total_payments_made" /> </div> -->
                    <div class="full">
                ...
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 py-1"
                    v-else-if="payment.reservation_type == 5 || payment.reservation_type == 6 || payment.reservation_type == 7">
                    <div class="flex gap-4">
                        <div class="w-2/5"> <readonly-form label="Last Name" :value="buyer.last_name" /> </div>
                        <div class="w-2/5"> <readonly-form label="First Name" :value="buyer.first_name" /> </div>
                        <div class="w-1/5"> <readonly-form label="M.I." :value="buyer.middle_initial" /> </div>
